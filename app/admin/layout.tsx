...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="admin-shell">
    <aside className="admin-side">
      ...
      <div className="admin-side-footer"><div className="admin-avatar">{initials}</div><div><strong>{personName}</strong><span>{role==='superadmin'?'Superadministrador':role.replaceAll('_',' ')}</span></div><form action="/admin/logout" method="post"><button type="submit" title="Sair" aria-label="Sair do painel">↗</button></form></div>
    </aside>
